...
/**
 * Parse vendors
 * @param {Set<String>|Array<String>|String} vendor -
 * @returns {Set<String>} - set of enabled vendors
 */

function parseVendors(vendor) {
  if (Array.isArray(vendor) || vendor instanceof Set) {
    for (const v of vendor) {
      assert(typeof v === 'string');
      const name = v.toUpperCase();
      assert(AVAILABLE_VENDORS.has(name),
  ...
  assert(typeof vendor === 'string');
  vendor = vendor.toUpperCase();

  if (vendor === 'ANY')
    return new Set(AVAILABLE_VENDORS);
...
exports.AVAILABLE_VENDORS = AVAILABLE_VENDORS;
exports.parseVendors = parseVendors;
exports.bip44 = bip44;
exports.hash = hash;
