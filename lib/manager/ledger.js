...
class LedgerDeviceManager extends AbstractDeviceManager {
  ...
  bind() {
    ...
    this.usb.on('connect', this._connectHandler);
    this.usb.on('disconnect', this._disconnectHandler);
  }
  ...
  unbind() {
    this.usb.removeListener('connect', this._connectHandler);
    this.usb.removeListener('disconnect', this._disconnectHandler);
